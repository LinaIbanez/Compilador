...
int vawhile=0,vafor=0,vai=0,vasu=0;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 470, 1000, 120));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 40, 550, 120));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/analizador/lexico/11.png"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 70, -1, 90));

        jScrollPane2.setBorder(null);
        jScrollPane2.setForeground(new java.awt.Color(255, 255, 255));
        jScrollPane2.setFont(new java.awt.Font("Serif", 0, 24)); // NOI18N

        areacadena.setBackground(javax.swing.UIManager.getDefaults().getColor("Button.focus"));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 660, 280));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, -40, 790, 660));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/analizador/lexico/4.png"))); // NOI18N
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 0, 480, 610));
...
DefaultTableModel modelo = (DefaultTableModel) tabla.getModel();
  for (int i = 0; i < tabla.getRowCount(); i++) {
    ...
    private void btnlexicoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnlexicoActionPerformed
        ...
        String cadena=("(int|for|while|if|else|public|static|private|String|Double|println|boolean|char|class|this|void|return|System|do)|([a-zA-Z]+)|([0-9]+)|([{|}|>|<|==|=|-|+|/|*|;|.|,|(|)])");       
